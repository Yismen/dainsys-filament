...
describe('Application Model', function (): void {
    describe('Factory', function (): void {
        it('can create an application with factory', function (): void {
        ...
        it('creates application with applicant and job opening', function (): void {
            $application = Application::factory()->create();
        ...
        it('creates application with applied status by default', function (): void {
            $application = Application::factory()->create();
        ...
        it('has applied_at date', function (): void {
            $application = Application::factory()->create();
    ...
    describe('Attributes', function (): void {
        ...
        it('casts status to ApplicationStatuses enum', function (): void {
            $application = Application::factory()->create([
        ...
        it('casts applied_at to date format', function (): void {
            $application = Application::factory()->create();
    ...
    describe('Relationships', function (): void {
        it('belongs to applicant', function (): void {
        ...
        it('belongs to job opening', function (): void {
        ...
        it('can retrieve applicant name through relationship', function (): void {
        ...
        it('can retrieve job opening title through relationship', function (): void {
    ...
    describe('Soft Deletes', function (): void {
        it('soft deletes application', function (): void {
            $application = Application::factory()->create();
        ...
        it('can restore soft deleted application', function (): void {
            $application = Application::factory()->create();
            $application->delete();

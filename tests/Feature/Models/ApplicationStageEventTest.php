...
describe('ApplicationStageEvent Model', function () {
    describe('Factory', function () {
        it('can create an application stage event with factory', function () {
        ...
        it('creates event with application and recruitment stage', function () {
            $event = ApplicationStageEvent::factory()->create();
        ...
        it('creates event with pending outcome by default', function () {
            $event = ApplicationStageEvent::factory()->create();

            expect($event->outcome)->toBe(StageOutcome::Pending);
        });

        it('has no completed_at by default', function () {
            $event = ApplicationStageEvent::factory()->create();

            expect($event->completed_at)->toBeNull();
        });

        it('generates optional scheduled_at date', function () {
            $event = ApplicationStageEvent::factory()->create();
    ...
    describe('Factory States', function () {
        it('can create passed event with completed_at', function () {
        ...
        it('can create failed event with completed_at', function () {
    ...
    describe('Attributes', function () {
        ...
        it('casts outcome to StageOutcome enum', function () {
            $event = ApplicationStageEvent::factory()->create([
        ...
        it('casts scheduled_at and completed_at to datetime', function () {
            $event = ApplicationStageEvent::factory()->create([
    ...
    describe('Relationships', function () {
        it('belongs to application', function () {
        ...
        it('belongs to recruitment stage', function () {
        ...
        it('can retrieve application data through relationship', function () {
            $application = Application::factory()->create();
            $event = ApplicationStageEvent::factory()->create(['application_id' => $application->id]);
        ...
        it('can retrieve recruitment stage data through relationship', function () {
    ...
    describe('Soft Deletes', function () {
        it('soft deletes application stage event', function () {
            $event = ApplicationStageEvent::factory()->create();
            $eventId = $event->id;
        ...
        it('can restore soft deleted event', function () {
            $event = ApplicationStageEvent::factory()->create();
            $event->delete();

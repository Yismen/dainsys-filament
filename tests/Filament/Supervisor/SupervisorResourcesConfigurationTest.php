...
test('payroll hour resource is properly configured', function (): void {
...
test('nightly hour resource is properly configured', function (): void {
...
test('production resource is properly configured', function (): void {
...
test('employee metrics resource is properly configured', function (): void {

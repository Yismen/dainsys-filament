...
class EmployeeMetricsResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return Production::query()
            ...
            ->groupByRaw("{$weekGroupingExpression}, productions.employee_id, employees.first_name, employees.second_first_name, employees.last_name, employees.second_last_name, employees.full_name");
    }

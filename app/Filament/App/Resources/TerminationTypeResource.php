...
class TerminationTypeResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListTerminationTypes::route('/'),
            'create' => Pages\CreateTerminationType::route('/create'),
            'view' => Pages\ViewTerminationType::route('/{record}'),
            'edit' => Pages\EditTerminationType::route('/{record}/edit'),
        ];
    }
